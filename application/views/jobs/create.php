...
<p class="lead">
	<?php echo $this->lang->line('job_create_form_instruction_1'); ?>
</p>
...
<div class="span8">
	...
	<!-- form-group -->
	<!-- the types dropdown is populated by the get_types function in Jobs_model. it returns a result object that we loop over, allowing the user to select the type -->
	<div class="form-group">
	...
	<!-- form-group -->
	<!-- the category dropdown is populated by the get_categories() function in the Jobs_model. it returns a result object that we loop over, allowing the user to select the category -->
	<div class="form-group">
	...
	<!-- form-group -->
	<!-- the location dropdown is populated by the get_locations() function in the Jobs_model. it returns a result object that we loop over, allowing the user to select the location -->
	<div class="form-group">
		<?php form_error('loc_id'); ?>
	...
	<div class="row">
		<div class="form-group">
			...
			<div class="col-md-2">
				...
				<select name="sunset_y" class="form_control">
					<?php for ($i = date("Y", strtotime(date("Y"))); $i <= date("Y", strtotime(date("Y").' +3 year')); $i++): ?>
						<option value="<?php echo $i; ?>"><?php echo $i; ?></option>
					<?php endfor; ?>
				</select>
